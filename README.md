...
**Repo structure**: the notebook went through several iterations (v1 through v8) as I added hyperparameter tuning, more robust cost-sensitivity testing, bootstrap significance testing, SHAP explainability, additional datasets, and finally the stacked-ensemble comparison. Each version folder has its own README explaining what changed and why. v8 is the current/final pipeline.
